...
public final class ContentScraperFactory {
    private static final Map<String, ScraperSupplier<? extends ContentScraper>> CONTENT_SCRAPER_REGISTRY = new ConcurrentHashMap<>();

    private ContentScraperFactory() {
    }

    public static void register(String websiteBaseUrl, ScraperSupplier<? extends ContentScraper> contentScraperClass) {
